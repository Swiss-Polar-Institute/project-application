...
class ProjectsBalanceCsvTest(TestCase):
    ...
    def test_get_one_project(self):
        ...
        self.assertEqual(lines[0], '\ufeffKey;Signed date;Organisation;Title;Allocated budget;Balance due')
        self.assertEqual(lines[1], 'SPI-2020-001;No grant agreement attached;;This is a test project;20000,00;20000.00')
    ...
    def test_get_two_projects(self):
        ...
        self.assertEqual(lines[1],
                         'SPI-2020-001;No grant agreement attached;Some organisation;This is a test project;20000,00;20000.00')
        self.assertEqual(lines[2], 'SPI-2020-002;04/01/2020;;Second test;15000,00;13500.00')
