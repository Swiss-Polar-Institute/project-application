...
class CallAdmin(admin.ModelAdmin):
    ...
    'budget_categories_list', 'budget_maximum', 'call_questions_list', 'other_funding_question', 'proposal_partner_question', 'created_by', 'created_on', 'modified_by', 'modified_on', )
