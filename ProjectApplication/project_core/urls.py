...
urlpatterns = [
    ...
    path('logged/funding_instrument/add', logged.funding_instrument.FundingInstrumentCreateView.as_view(),
    ...
    path('logged/funding_instrument/<int:pk>/update',
         logged.funding_instrument.FundingInstrumentUpdateView.as_view(),
