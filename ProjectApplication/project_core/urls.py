...
urlpatterns = [
    ...
    path('logged/proposal/<uuid:uuid>/evaluation', logged.proposal.ProposalEvaluationDetail.as_view(),
         name='logged-proposal-evaluation-detail'),
    path('logged/proposal/<uuid:uuid>/evaluation/update/', logged.proposal.ProposalEvaluationUpdate.as_view(),
