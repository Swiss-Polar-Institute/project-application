...
urlpatterns = [
    ...
    path('logged/grant-management/project/<int:project>/field_notes/update/',
         grant_management.views.FieldNoteUpdateView.as_view(),
         name='logged-grant_management-field_notes-update'),
    ...
    path('logged/grant-management/project/<int:project>/carbon_emission/update/',
         grant_management.views.CarbonEmissionUpdateView.as_view(),
         name='logged-grant_management-carbon-emission-update'),
    ...
    path('logged/grant-management/project/<int:project>/persons/update/',
         grant_management.views.PersonsUpdateView.as_view(),
         name='logged-grant_management-persons-update'),
    ...
    path('logged/grant-management/project/<int:project>/underspendings/update/',
         grant_management.views.UnderspendingsUpdateView.as_view(),
         name='logged-grant_management-underspendings-update'),
